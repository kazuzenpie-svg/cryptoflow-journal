...
DROP FUNCTION IF EXISTS public.generate_trader_uid();
...
DROP FUNCTION IF EXISTS public.log_trade_changes();
...
DROP FUNCTION IF EXISTS public.check_binding_limit();
...
DROP FUNCTION IF EXISTS public.validate_investment_pnl();
